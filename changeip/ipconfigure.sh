...
IFACECFG=$(find /etc/sysconfig/network-scripts/ -name "ifcfg-*"  | head -n 1)
[[ -f /etc/sysconfig/network-scripts/ifcfg-$IFACE ]] || cp $IFACECFG /etc/sysconfig/network-scripts/ifcfg-$IFACE 
